...
public class CitiesSuggestionProvider extends ContentProvider {

	 String TAG = "CitiesSuggestionProvider";

	    public static String AUTHORITY = "com.threebars.worldclock2.CitiesSuggestionProvider";
	    ...
	    private static UriMatcher buildUriMatcher() {
	        ...
	        // to get definitions...
	        matcher.addURI(AUTHORITY, "dictionary", SEARCH_CITIES);
	        matcher.addURI(AUTHORITY, "dictionary/#", GET_CITY);
	        // to get suggestions...
