...
//        TIMEZONE_MAPPINGS.put("GMT Standard Time", "GMT");
    ...
    {
    	return TIMEZONE_MAPPINGS.get(timeZoneString);
//    	return getKeyByValue(TIMEZONE_MAPPINGS, timeZoneString);
    }
    
	public static <T, E> T getKeyByValue(Map<T, E> map, E value) {
		Log.d("TAG", "looking for : "  + value);
		if(value == null)
		{
			return null;
		}
	...
	public static TimeZone getDSTTimeZone(CityTimeZone cityTimeZone) {
		...
		{
			return DateTimeZone.forID(timeZoneName).toTimeZone();	
		}
		else
		{
			return TimeZone.getTimeZone(cityTimeZone.timezone);
		}
	}
