...
public class CitiesProvider extends ContentProvider {
    String TAG = "CitiesProvider";

    public static String AUTHORITY = "com.threebars.worldclock2.CitiesProvider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "cities", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "cities/#", GET_WORD);
        // to get suggestions...
